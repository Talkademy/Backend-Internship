...
در این پروژه، که تقریبا در میانه‌ی مسیر کارآموزی شما است، توانمندی و تسلط شما بر مطالبی که تا کنون آموخته‌ای را می‌آزماید. با توجه به فضای کاری شرکت، قصد داریم جهت آشنایی بیشتر شما با فضای پیام‌رسانی، پیاده‌سازی یک چت‌روم ساده را به شما محول کنیم.
