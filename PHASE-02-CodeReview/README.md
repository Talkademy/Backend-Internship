...
[لیست تسک‌های مرتبط با این فاز به صورت issue template](https://github.com/Talkademy/Backend-internship/blob/reviewPhase00/PHASE-02-CodeReview/02-CodeReview-Tasks.md)
