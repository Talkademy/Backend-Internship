...
1. قبل از شروع این فاز حدود نیم ساعت تا یک ساعت در مورد دو سوال زیر سرچ کنید و با هم تیمی خود بحث کنید، بعد از پایان بحث برای هر سوال سه دلیل را که فکر می‌کنید از بقیه مهم‌تر هستند در فایلTasklist نمایید:
...
1. بعد از مطالعه موارد مرحله‌ی قبل دوباره به سوالات مرحله‌ی اول فکر کنید و بعد از بحث با هم تیمی خود جواب‌های جدید را در فایلTaskList بنویسید.
